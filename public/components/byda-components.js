...
`;
  ...
  var BydaStatusCard = class extends HTMLElement {
    ...
    render() {
      ...
      const description = getTrimmedAttribute(this, "description") || "Ship this as a single Web Component and reuse it in WordPress, React, Angular, or a plain HTML page.";
