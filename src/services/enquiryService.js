...
function toLocalHistoryItem(record) {
  return {
    ...
    digStartAt: record.input?.digStartAt ?? null,
    digEndAt: record.input?.digEndAt ?? null,
...
function mergeHistoryItem(localRecord, remoteRecord) {
  return {
    ...
    digStartAt: localRecord.input?.digStartAt ?? null,
    digEndAt: localRecord.input?.digEndAt ?? null,
